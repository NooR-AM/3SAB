...
data = {
{
{text = 'تأكيد الطفره', data = '/Zxchq'..msg_chat_id}, {text = 'الغاء الطفره', data = msg.sender.user_id..'/Redis'}, 
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id,'*᥀︙ يرجى تأكيد الطفره ولك*',"md",false, false, false, false, reply_markup)
end
...
if text == 'السورس' or text == 'سورس' or text == 'ياسورس' or text == 'source' then  photo = "https://t.me/K_E_R"
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
return LuaTele.sendText(msg_chat_id,msg_id,'*كہآلعہآده جہبہل ؤآنہت😋🌺️*',"md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'*هـلا بالـعافـيه🥺💝 ️*',"md",false, false, false, false, reply_markup)
end
...
if text == 'تعالي خاص' or text == 'خاص' or text == 'خ' then
if not Redis:get(The3SAB.."3SAB:Sasa:Jeka"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"* *","md",true)  
end
local reply_markup = LuaTele.replyMarkup{

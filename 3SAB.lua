...
msg.The_Controller = 1
elseif The_ControllerAll(msg.sender.user_id) == 1848546111 then  
msg.The_Controller = 1
...
Redis:del(The3SAB.."3SAB:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم تغيير صوره المجموعه الى ","md",true)    
end
...
{
{text = '᥀ اضفني الى مجموعة .', url = 't.me/'..UserBot..'?startgroup=new'}, 
},
}
}

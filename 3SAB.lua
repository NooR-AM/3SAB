...
if text == 'السورس' or text == 'سورس' or text == 'يا سورس' or text == 'source' then photo = "https://t.me/K_E_R"
local T =[[
]]
keyboard = {} 
keyboard.inline_keyboard = {{
...
{
{text = 'تواصل السورس', url = 't.me/TNOONTBOT'}, 
},
{
{text = 'مطور السورس', url = 't.me/E_H_T'}, 
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id, [[
...
"أჂ̤ أჂ̤ هياتني اني",
"موجود بس لتصيح",
"لتــلح دا احجي ويه بنات عصب بعدين اجاوبك",
